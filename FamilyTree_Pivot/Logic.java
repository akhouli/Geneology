...
public class Logic {
	...
	public Logic(int id, String firstname, String lastname, boolean male, String birthdate, String birthplace, int familyID) {
		this.id = id;
		this.firstname = firstname;
		this.lastname = lastname;
		this.male = male;
	...
	public Logic(String firstname, String lastname, boolean male, String birthdate, String birthplace, int familyID, String deathdate, String deathplace) {
		this.firstname = firstname;
		this.lastname = lastname;
		this.male = male;
		this.birthdate = birthdate;
