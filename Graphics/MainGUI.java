...
//				biographyArea.clear();
//				try {
//					BufferedWriter writer = new BufferedWriter(new FileWriter("src/Graphics/treeName.txt",true));
...
//
//				BufferedReader reader = new BufferedReader(new FileReader("src/Graphics/help.txt"));	
//				String a = "";
//				String line;
//
...
//		else {
//			try {
//				BufferedWriter writer = new BufferedWriter(new FileWriter("src/Graphics/newNode.txt",true));
//			writer.newLine();
...
//	public void handle(MouseEvent event) {
////		try {
////			BufferedReader reader = new BufferedReader(new FileReader("src/Graphics/treeName.txt"));	
////			String a = "";
////			String inc= "";
////			String line;
////
...
//		        ((Group) scene.getRoot()).getChildren().addAll(vbox,backSearch,viewTree);
//
